...
params = {'early_stopping': False, 'l2_regularization': 0.2, 'learning_rate': 0.05, 'loss': 'squared_error', 'max_depth': 5, 'max_iter': 400, 'max_leaf_nodes': 15, 'validation_fraction': 0.2}
...
submission.to_csv('main_submission-4.csv', index=False)